package com.way2learnonline.quotes.controller;
...
import com.way2learnonline.quotes.service.QuoteService;
...
public class QuoteController {
	...
	public ResponseEntity<List<Quote>> getQuotes(@RequestParam(value="q", required=false) String query) throws SymbolNotFoundException, InterruptedException {
		...
		if(delay!=0) {
			System.err.println("Sleepting for "+delay +" milli seconds");
			Thread.sleep(delay);
		}
